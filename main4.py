...
def play():
    ...
    import cv2
    #===============第一个找红包位置.
    def click_close_button(littlepngs=['bugclose.png','bugclose2.png','bugclose3.png','bugclose4.png','bugclose5.png','bugclose6.png','close_button6.png'],sleeptime=0.4):
        print("下面关闭bug_close")
        import time
        # time.sleep(1)
        os.system('adb shell /system/bin/screencap -p /sdcard/screencap.png')
    ...
    a = os.system('adb shell input tap ' + str(int(566)) + ' ' + str(int(1350)))  #
