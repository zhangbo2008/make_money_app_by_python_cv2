...
#关闭随时搞心态的那些弹窗广告
    def click_close_button(littlepngs=['bugclose.png','bugclose2.png','bugclose3.png','bugclose4.png','bugclose5.png','bugclose6.png','close_button6.png'],sleeptime=0.3):
        print("下面关闭bug_close")
        import time
        # time.sleep(1)
        os.system('adb shell /system/bin/screencap -p /sdcard/screencap.png')
...
#===========上来先答题:
    ...
    while not whether_exist('shouxia.png'):
        click_close_button()
    point = 538, 1241
    os.system(
        'adb shell input tap ' + str(int(point[0])) + ' ' + str(int(point[1])))
    ...
    while not whether_exist('xiayiguan.png'):
        click_close_button()
